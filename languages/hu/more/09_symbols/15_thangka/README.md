...
> A [megvilágosodás](../../10_concepts/README.md#3-megvilágosodás-bodhi-awakening) nem absztrakt—**formája, irányultsága és belső geometriája van**.
...
* A pontos ikonográfia évszázadokon át változatlanul megőrzi a tanításokat
* Az arányok szigorú kanonikus méréseket követnek
* A szimbolizmus megkerüli a koncepcionális gondolkodást és közvetlenül az észlelésbe nyomódik

Ez az oka annak, hogy a thangkákat *"látó tanításoknak"* nevezik, nem illusztrációknak.
...
* A gyakorló külsőleg tanulmányozza a képet
* Majd belsőleg rekonstruálja növekvő pontossággal
* Végül a kép, megfigyelő és elme közötti különbség feloldódik

Ez trenírozza:

* **Stabilitást** (śamatha)
* **Tisztaságot** (vipaśyanā)
* **Nem-duális észlelést**
...
* Feltekeredve → **potenciál** (megnyilvánulatlan)
* Kitekerve → **megjelenés**
* Újra feltekeredve → **feloldás**

Ez tükrözi:

* [Múlandóságot](../../01_core_teachings/impermanence/README.md#2-a-múlandóság-anicca-strukturális-nem-véletlen)
* [Ürességet](../../10_concepts/01_emptiness/README.md#emptiness-nyat-in-vajrayna-buddhism)
* A jelenségek keletkezését és feloldódását a [meditációban](../../08_lineage/README.md)
...
* Az eltérések hibák, nem kreativitás
* Az ego-kifejezést szándékosan elnyomják
* A festő **technikai átadóként** működik, nem művészként

Ez egy alapvető buddhista elvet tükröz:
...
* Meditációs ülések horgonyzására
* Motiváció rekalibrálására
* A helyes nézet helyreállítására, amikor az elme elsodródik
* A leszármazási folytonosság fenntartására kolostorokon kívül

**Interfészek** a hétköznapi észlelés és az ébredett struktúra között.

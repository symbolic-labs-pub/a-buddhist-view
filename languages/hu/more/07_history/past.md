...
![history.png](../../../../more/07_history/history.png)
...
flowchart TB
  %% ==========================================
  %% 🌈 LEGENDA — Karma Kagyu Leszármazási Vonal Grafikon
  %% A csomópontok színeit, emojikat és él színeket magyarázza
  %% ==========================================

  %% ---------- Csomópont példák ----------
  CoreNode["👑 Központi Leszármazási Vonal Birtokosa<br/>(Karmapa)"]
  BranchANode["👑 A Ág<br/>(Kék vonal)"]
  BranchBNode["👑 B Ág<br/>(Rózsaszín vonal)"]
  RegentNode["🧘 Vezető Tanítvány / Régens"]
  DalaiNode["☸️ Külső Hatóság<br/>(Dalai Lama)"]

  SeatNode["🏯 Kolostor / Székhely"]
  InstituteNode["🎓 Intézet / Egyetem"]
  WebNode["🌐 Adminisztráció / Weboldal"]
  LegalNode["⚖️ Jogi / Bírósági Folyamat"]
  DocNode["📜 Dokumentum / Előrejelzés"]
  UnityNode["🤝 Kiegyezés / Egység Esemény"]

  %% ---------- Él példák ----------
  CoreNode -->|🏗️ Alapít / Létrehoz| SeatNode
  CoreNode -->|🧘 Átvitel| RegentNode
  RegentNode -->|🧭 Régensség / Kormányzás| SeatNode
  DocNode -->|🧩 Elismerési Befolyás| BranchANode
  DalaiNode -->|✅ Elismerés| BranchANode
  BranchANode -->|👑 Trónra ültetés| SeatNode
  BranchANode -->|📣 Kommunikáció| WebNode
  SeatNode -->|⚖️ Jogi Tengely| LegalNode
  BranchANode -->|🤝 Közös Nyilatkozat| UnityNode

  %% ---------- Stílusok (azonos paletta mint a fő grafikonban) ----------
...
flowchart TB
  ...
  %% ============================================================
  %% 🌈 Tibeti Buddhizmus történelem grafikon
  %% - Színes csomópont csoportok iskola szerint
  %% - Színes vonal típusok
  %% - Elemzésbiztos címkék (nincsenek zárójelek, nincsenek golyó elválasztók)
  %% ============================================================

  TB["🏔️ Tibeti Buddhizmus\n7. századtól napjainkig"]

  %% ================= Nyingma =================
  subgraph NY["🔴 Nyingma Ősi Iskola 8. század"]
    Trisong["👑 Trisong Detsen Király\n8. század"]
    Shantarak["🧑‍🏫 Shantarakshita\n8. század"]
    GuruR["🪷 Guru Rinpoche Padmasambhava\n8. század"]
    Samye["🏯 Samye Kolostor\nkb. 779"]
    Dzogchen["✨ Dzogchen Nagy Tökéletesség"]
    KamaTerma["📦 Kama és Terma átvitelek"]
  end

  %% ================= Kagyu =================
  subgraph KA["🔵 Kagyu Szóbeli Leszármazási Vonal 11. század"]
    Tilopa["🧘 Tilopa\n989-től 1069-ig"]
    Naropa["🧘 Naropa\n1016-tól 1100-ig"]
    Marpa["🧑‍🌾 Marpa a Fordító\n1012-től 1097-ig"]
    Mila["🏔️ Milarepa\n1040-től 1123-ig"]
    Gampopa["📜 Gampopa\n1079-től 1153-ig"]
    K1["👑 Első Karmapa Dusum Khyenpa\n1110-től 1193-ig"]
    KK["👑 Karma Kagyu leszármazási vonal"]
  end

  %% ================= Karma Kagyu modern =================
  subgraph KKMOD["🟦 Karma Kagyu Modern Kor 20. és 21. század"]
    K16["👑 16. Karmapa\n1924-től 1981-ig"]
    Rumtek["🏯 Rumtek Kolostor\n1966 száműzetési székhely"]
    KIBI["🎓 KIBI Újdelhi\n1979"]
    HeartSons["🧭 Régensségi időszak\n1981-től 1990-es évekig"]
    SH14["🟥 14. Shamarpa\n1952-től 2014-ig"]
    TS12["🟦 12. Tai Situ Rinpoche"]
    GY12["🟩 12. Goshir Gyaltsab Rinpoche"]
    JKX["🟪 Jamgon Kongtrul Rinpoche"]
    Pred["📜 Előrejelzési Levél\n1990-es évek vitatott"]
    K17A["👑 17. Karmapa Ogyen Trinley Dorje\nelismerve 1992"]
    K17B["👑 17. Karmapa Trinley Thaye Dorje\nelismerve 1994"]
    Escape["🧳 Szökés Tibetből\n1999-től 2000-ig"]
    Joint2018["🤝 Közös nyilatkozat\n2018"]
    Joint2023["🤝 Közös nyilatkozat\n2023"]
  end

  %% ================= Sakya =================
  subgraph SA["🟡 Sakya Iskola 1073"]
    Khon["👑 Khon Konchok Gyalpo\n1034-től 1102-ig"]
    SakyaMon["🏯 Sakya Kolostor\n1073"]
    Lamdre["🧠 Lamdre Út és Gyümölcs"]
  end

  %% ================= Gelug =================
  subgraph GE["🟠 Gelug Iskola 15. század"]
    Tsong["🧑‍🏫 Je Tsongkhapa\n1357-től 1419-ig"]
    Ganden["🏯 Ganden Kolostor\n1409"]
    DalaiTitle["🏷️ Dalai Lama cím\n1578"]
    DL14["☸️ 14. Dalai Lama\nszületett 1935\ntrónra ült 1940\nszáműzetésben 1959 óta"]
  end

  %% ================= Rimé =================
  subgraph RI["🟣 Rime Nem-Szektárius Mozgalom 19. század"]
    Rime["🧩 Rimé mozgalom"]

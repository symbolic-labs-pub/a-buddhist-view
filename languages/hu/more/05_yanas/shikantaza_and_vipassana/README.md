## [Shared baseline: 3 knobs of attention](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/master/languages/hu/more/05_yanas/shikantaza_and_vipassana/README.md#shared-baseline-3-knobs-of-attention)
[![shikantaza_and_vipassana](../../../../../more/05_yanas/shikantaza_and_vipassana/shikantaza_and_vipassana.png)](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/master/languages/hu/more/05_yanas/shikantaza_and_vipassana/README.md#shared-baseline-3-knobs-of-attention)
...
* Then **systematic noting** or clear observation:
  ...
  * detect [Múlandóság](../../01_core_teachings/impermanence/README.md#2-a-múlandóság-anicca-strukturális-nem-véletlen), [unsatisfactoriness](../../02_from_ignorance_to_awakening/2_the_four_noble_truths/README.md#1-van-szenvedés-dukkha), not-self
...
* insight into non-ownership ([anattā](../../02_from_ignorance_to_awakening/1_the_three_marks_of_existence/README.md#3-nem-en-anatt))
...
* **Over-labeling**: turning Gyakorlat into narration (Fogalmak replace perception)
...
### Object model
Key shift: from *contents* to **mind/knowing itself** (and the inseparability of appearance and [emptiness](../../10_concepts/01_emptiness/README.md#emptiness-nyat-in-vajrayna-buddhism)).
...
* thoughts are seen as **movements within Tudatosság**
...
### Pitfalls
* **Reifying Tudatosság**: making “the watcher” into a subtle object
* **Conceptual nonduality**: understanding the words, not the pivot
* **Oscillation**: brief clarity then long distraction
* **Bliss fixation**: mistaking pleasant [samadhi](../../01_core_teachings/the_noble_eightfold_path/README.md#8-helyes-koncentracio-samm-samdhi) for realization

**Signature:** uses *precision inquiry* to flip attention into Tudatosság-mode, then stabilizes that.
...
* **recognize → remain → allow self-Felszabadulás**
...
### Pitfalls
* **Mistaking blankness for [rigpa](#4-dzogchen-nyingma-etc-recognition-of-rigpa-self-felszabadulás-no-fabrication)** (the #1)
* **Premature “nothing to do”** without stable recognition
* **Bypassing**: skipping [ethics](../../01_core_teachings/the_noble_eightfold_path/README.md#2-etikus-magatartas-la)/psychological integration
...
| Gyakorlat   |            Selectivity | Effort style           | Primary move                       | “Unit” of progress                  |
| ---------- | ---------------------: | ---------------------- | ---------------------------------- | ----------------------------------- |
...
| [Mahāmudrā](#3-mahāmudrā-kagyusakya-etc-object-to-tudatosság-pivot-nondual-shamathainsight)  |               variable | probe-then-rest        | pivot from objects → [Tudatosság](#2-shikantaza-zen-just-sitting-global-tudatosság-with-minimal-intervention)     | stable nondual clarity              |
| [Dzogchen](#4-dzogchen-nyingma-etc-recognition-of-rigpa-self-felszabadulás-no-fabrication)   | very broad (but vivid) | "unfabricated"         | recognize rigpa; self-liberate     | continuity of recognition           |
...
3. **Mahāmudrā → watcher**
   ...
   * Tudatosság becomes a subtle “thing” you hold.
...
* too “high” → bliss chasing (Mahāmudrā/[Vajrayāna](../README.md#4-vajrayna-tantrayna-mantrayna-the-diamond-vehicle) drift)

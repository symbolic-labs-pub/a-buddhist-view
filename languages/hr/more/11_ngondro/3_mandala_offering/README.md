## [The Third Ngöndro Praksa](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/11_ngondro/3_mandala_offering/README.md#the-third-ngöndro-praksa)

[![mandala_offering](mandala_offering.png)](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/11_ngondro/3_mandala_offering/README.md#the-third-ngöndro-praksa)
### **Mandala Offering (Offering the Universe)**

In the [Vajrayāna](../../05_yanas/README.md#4-vajrayāna-tantrayāna-mantrayāna---the-diamond-vehicle) put—especially within the **Kagyu school**—the **third Ngöndro praksa** is the **[Mandala](../../09_symbols/07_mandala/README.md#mandala--explained-according-to-budistički-učenja) Offering**.
Its function is precise and structural: **to dismantle attachment at its root and replace scarcity-based identitet with enlightened abundance**.

This praksa trains the mind to **relinquish ownership itself**, not merely possessions.
...
This is why the mandala is called a **total offering**—it leaves no utočište for ego.

---

## 2. Why This Praksa Is Necessary


From a deep budistički perspective, **[patnja](../../02_from_ignorance_to_awakening/2_the_four_noble_truths/README.md#1-there-is-patnja--dukkha) is maintained by subtle possession**, even spiritual possession:

* “My” progress
* “My” praksa
* “My” patnja
* “My” [buđenje](../../10_concepts/README.md#3-enlightenment-bodhi-buđenje)
...
The praksa works through **repetitive symbolic relinquishment**.
...
* To the [**Three Jewels**](../../01_core_teachings/the_three_jewels/README.md#the-three-jewels-triple-gem--ti-ratana)
* To the **root guru**
* To the **loza**
...
[Guru Yoga](../4_guru_yoga/README.md#samsāra’s-unsatisfactoriness-→-guru-yoga) (the fourth Ngöndro)](#the-third-ngöndro-praksa)) requires:
...
Without this praksa, Guru Yoga easily becomes psychological dependence.
...
**The Mandala Offering trenira praktikanta to experience total abundance without ownership—so realization can arise without obstruction.**
...
* A **distributed system reset** for identitet
...
< [2. Vajrasattva — Purification of Obscurations](../2_purification/README.md) | [The Fourth Ngöndro Praksa](../4_guru_yoga/README.md) >

## [“All Conditioned Things Are Impermanent”](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/01_core_teachings/impermanence/README.md#all-conditioned-things-are-impermanent)

[![impermanence](impermanence.png)](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/01_core_teachings/impermanence/README.md#all-conditioned-things-are-impermanent)
**(Pāli: *sabbe saṅkhārā aniccā*)**

### 1. What *saṅkhārā* really means

In budistički učenje, *saṅkhārā* refers to **all conditioned phenomena**—anything that:
...
* physical matter (bodies, objekti, environments)
* mental formations (misli, emocije, intentions)
...
In early budistički analysis, even a single moment of experience is already **in flux**.

---

### 4. Why impermanence leads to patnja (*dukkha*)

The Buddha did **not** say impermanence itself is [patnja](../../02_from_ignorance_to_awakening/2_the_four_noble_truths/README.md#1-there-is-patnja--dukkha).

Patnja arises because:
...
It asks for **direct viđenje** (*[vipassanā](../../05_yanas/shikantaza_and_vipassana/README.md#1-vipassanā-theravāda-insight---“feature-extraction-de-reification”)*).
...
From a budistički perspective:

* If things were permanent → liberation would be impossible
* Because things change → transformation is possible
* [Buđenje](../../10_concepts/README.md#3-enlightenment-bodhi-buđenje) itself depends on impermanence
...
> When one sees this with [mudrost](../the_noble_eightfold_path/README.md#1-mudrost-paññā),
> one turns away from patnja.”


---

< [Core Učenja](../README.md) | [What “Pāramitā” Means in Buddhism](../perfections/README.md) >

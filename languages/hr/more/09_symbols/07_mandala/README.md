### Mandala — explained according to budistički učenja
...
* The **outer rings** (fire, [vajra](../02_dorje/README.md#dorje-vajra--explained-according-to-budistički-učenja), [lotus](../08_lotus/README.md#the-lotus-in-budistički-učenje)) represent the purification of obscurations.

In budistički terms, the mandala is a **display of [dependent origination](../../02_from_ignorance_to_awakening/3_dependent_origination/README.md#the-twelve-links-the-classic-formulation) seen clearly**—how [mudrost](../../01_core_teachings/the_noble_eightfold_path/README.md#1-mudrost-paññā), [suosjećanje](../../02_from_ignorance_to_awakening/7_compassion/README.md#suosjećanje-as-a-structural-principle-in-budistički-učenje), clarity, and activity arise together when ignorance is absent.
...
This is why mandalas are precise to the millimeter in traditional praksa.
...
## 3. Visualization praksa (generation stage)
...
> The highest mistake in Buddhism is attachment to [buđenje](../../10_concepts/README.md#3-enlightenment-bodhi-buđenje) experiences.
...
* It encodes ethics, mudrost, and suosjećanje simultaneously
...
Without these, mandala praksa becomes aesthetic fantasy.

---

## 6. The deepest point

Ultimately, budistički učenje states:
...
< [Mala (Prayer Beads) — Explained According to budistički Učenja](../06_mala/README.md) | [1. Purity *without* Rejection](../08_lotus/README.md) >

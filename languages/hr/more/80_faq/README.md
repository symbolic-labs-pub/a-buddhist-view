## [Često Postavljana Pitanja](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/80_faq/README.md#frequently-asked-questions)

[![faq.png](faq.png)](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/80_faq/README.md#frequently-asked-questions)

<details>
<summary>1. Što je Mahāmudrā?</summary>

**Mahāmudrā** means *"Great Seal."*
Odnosi se na **direktnu realizaciju prirode uma**—[empty](../10_concepts/01_emptiness/README.md#emptiness-śūnyatā-in-vajrayāna-buddhism), luminous, and aware.

U Mahāmudri:

* Um nije *kreiran* ili *poboljšan*
* Stvarnost je **prepoznata**, a ne fabrikirana
* Misli nisu prepreke već izrazi [svjesnosti](../10_concepts/README.md#2-awareness-rigpa-vijñāna-knowing)

> Mahāmudrā učи *viđenja uma kakav jest*.
...
<details>
<summary>2. Što je Dzogchen?</summary>

**Dzogchen** means *"Great Perfection."*
Pokazuje direktno na **rigpu**—primordijalne svjesnosti that is:

* Prazna (śūnya)
* Sjajna (jasnoća)
* Samo-znajuća (reflexive awareness)
...
| ---------- | ------------------------- | ----------------------------- |
| Put style | Progressive → direct      | Direct from the start         |
...
Usually refers to the **[Vajra](../09_symbols/02_dorje/README.md#dorje-vajra--explained-according-to-budistički-učenja) Guru Mantra**.
...
> [Lotus](../09_symbols/08_lotus/README.md#the-lotus-in-budistički-učenje)-born master, grant realization. Hūṁ."

**Meaning:**
Invocation of **indestructible awakened [mudrost](../01_core_teachings/the_noble_eightfold_path/README.md#1-mudrost-paññā)**.
...
**Function:**
Dissolves dualistic perception before praksa.
...
<details>
<summary>7. What is meditacija?</summary>

Meditacija is **not razmišljanje less**.

Meditacija is:

* Recognizing awareness
* Remaining without manipulation
* Allowing misli to self-liberate

> Meditacija is *non-distraction*, not [concentration](../01_core_teachings/the_noble_eightfold_path/README.md#8-right-concentration-sammā-samādhi).
...
* [Suosjećanje](../02_from_ignorance_to_awakening/7_compassion/README.md#suosjećanje-as-a-structural-principle-in-budistički-učenje) arising spontaneously
...
> Enlightenment is *viđenje clearly, all the time*.
...
<details>
<summary>9. How does removing ignorance eliminate patnja?</summary>

Ignorance (*avidyā*) is:

* Mistaking misli for self
...
> Patnja ends not by changing the world,
> but by **viđenje the world correctly**.
...
<details>
<summary>10. Why do misli not need to be stopped?</summary>
...
<details>
<summary>11. Why is suosjećanje inseparable from mudrost?</summary>

Because:

* Seeing emptiness removes self-centeredness
* Without self, others naturally matter
* Suosjećanje is not moral—it is structural
...
<details>
<summary>13. Why are loza and transmission emphasized?</summary>
...
<details>
<summary>14. Can ordinary life be praksa?</summary>

Yes.
In Mahāmudrā and Dzogchen:

* Eating is meditacija
* Thinking is meditacija
* Dying is meditacija
...
< [The Preliminary Prakse (Ngöndro)](../11_ngondro/README.md) | [A budistički View](../../README.md) >

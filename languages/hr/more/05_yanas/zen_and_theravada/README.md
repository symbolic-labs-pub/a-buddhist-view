## [1) How they *structure* the put](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/05_yanas/zen_and_theravada/README.md#1-how-they-structure-the-put)

[![zen_and_theravada](zen_and_theravada.png)](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/05_yanas/zen_and_theravada/README.md#1-how-they-structure-the-put)
...
* [**Vajrayāna**](../README.md#4-vajrayāna-tantrayāna-mantrayāna---the-diamond-vehicle) (tantra: [yoga božanstva](../../03_the_path_to_end_suffering/README.md#right-action), mantra, subtle body)
...
This is usually taught as **a layered stack** (often via *Lamrim* / graduated put).
...
* A **praksa container** (zazen, koan introspection, or shikantaza) rather than a multi-yāna taxonomy
...
**Single primary vehicle framing** (in its self-understanding): the put to **Nibbāna** via:

* **Sīla / Samādhi / [Paññā](../../01_core_teachings/the_noble_eightfold_path/README.md#1-mudrost-paññā)**
* [Four Noble Truths](../../02_from_ignorance_to_awakening/2_the_four_noble_truths/README.md#the-four-noble-truths--as-the-buddha-meant-them), [Noble Eightfold Put](../../01_core_teachings/the_noble_eightfold_path/README.md#what-the-noble-eightfold-put-is-in-buddhism), [Ovisno Podrijetlo](../../02_from_ignorance_to_awakening/3_dependent_origination/README.md#the-twelve-links-the-classic-formulation)

Theravāda preserves an early canonical emphasis on **arhatship** as the normative “completion” of the put (while still respecting bodhisatta ideals in various ways).
...
## 2) What “buđenje” means (and where it “lands”)


### Tibetan

* **Śrāvakayāna result**: arhat-style liberation (cessation of gross afflictions)
* **Mahāyāna result**: full **Buddhahood** (omniscient [suosjećanje](../../02_from_ignorance_to_awakening/7_compassion/README.md#suosjećanje-as-a-structural-principle-in-budistički-učenje) activity)
* **Vajrayāna claim**: same Buddhahood, but **faster** via “taking the result as the put”
...
Zen “[buđenje](../../10_concepts/README.md#3-enlightenment-bodhi-buđenje) talk” often centers on:

* **kenshō / satori** (viđenje one’s nature)
* Then **integration**: embodiment through daily life and ongoing praksa

Zen tends to distrust turning buđenje into a “thing” you can own conceptually, so it emphasizes *directness* and *anti-reification*.

### Theravāda

Buđenje is typically articulated through:
...
* Strong focus on **śūnyatā** (emptiness of inherent existence) and [**two truths**](../../02_from_ignorance_to_awakening/5_the_two_truths/README.md#the-two-truths-in-budistički-učenje)
* Often more “ontological-epistemic”: dismantle inherent existence assumptions, unite mudrost + suosjećanje

**Zen dialect**

* Strong focus on **non-conceptual immediacy** (suchness), with učenja designed to short-circuit reification
* Uses paradox/koan to break “the mind that wants to stand outside experience and explain it”

A useful bridge conceptually:

* Theravāda “not-self” and Mahāyāna “emptiness” are often **functionally convergent** in praksa, even when the philosophical packaging differs.

---

## 4) Praksa mapping (what corresponds to what)


| Training domain      | Theravāda                                    | Zen                            | Tibetan                                            |
| -------------------- | -------------------------------------------- | ------------------------------ | -------------------------------------------------- |
| [Ethics](../../01_core_teachings/the_noble_eightfold_path/README.md#2-ethical-conduct-śīla)               | precepts, monastic vinaya                    | precepts + communal praksa   | vows (pratimoksha / [bodhisattva](../../08_lineage/08_bodhisattva/README.md#4-the-bodhisattva-vow-as-structural-alignment) / samaya)          |
| [Concentration](../../01_core_teachings/the_noble_eightfold_path/README.md#8-right-concentration-sammā-samādhi)        | jhāna / samatha                              | zazen stability                | shamatha + [yoga božanstva](../../03_the_path_to_end_suffering/README.md#right-action) stabilization                |
| Insight              | [vipassanā](../shikantaza_and_vipassana/README.md#1-vipassanā-theravāda-insight---“feature-extraction-de-reification”) (anicca/dukkha/anattā)/[dukkha](../../02_from_ignorance_to_awakening/2_the_four_noble_truths/README.md#1-there-is-patnja--dukkha)/[anattā](#3-view-emptiness-non-self-and-“suchness”-same-direction-different-dialects))             | direct viđenje (kenshō), koan   | analytical insight + [emptiness](#3-view-emptiness-non-self-and-“suchness”-same-direction-different-dialects) reasoning           |
| [Suosjećanje](../../02_from_ignorance_to_awakening/7_compassion/README.md#suosjećanje-as-a-structural-principle-in-budistički-učenje) as method | present, but less central in “put identitet” | present (bodhisattva ethos)    | central: **bodhicitta** is non-negotiable          |
| Esoteric methods     | generally no                                 | generally no (rare exceptions) | yes: [mantra](../../09_symbols/10_mantra/README.md#what-a-mantra-is-buddhist-view), yoga božanstva, subtle body, empowerments |
...
* **Zen**: sudden “viđenje,” then long cultivation (often implicit)
...
* **Zen → Tibetan**
  ...
  * Add-on: structured vows/stages + analytic emptiness + explicit suosjećanje frameworks

* **Tibetan → Zen**

  * Your strengths: rich method stack, explicit integration of suosjećanje/mudrost
  * Add-on: simplifying to “just this” praksa, allowing realization to be ordinary and unadorned
...
* **Tibetan** optimizes for **a full-stack curriculum with multiple accelerators** (powerful, but requires good governance: vows/učitelj/context).

## [Shared baseline: 3 knobs of attention](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/05_yanas/shikantaza_and_vipassana/README.md#shared-baseline-3-knobs-of-attention)

[![shikantaza_and_vipassana](shikantaza_and_vipassana.png)](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/languages/hr/master/more/05_yanas/shikantaza_and_vipassana/README.md#shared-baseline-3-knobs-of-attention)
...
3. **Reification** — whether you treat experience as “things” (objekti) or as “display/knowing”
...
Experience is parsed into **events**: sensations, feelings, intentions, misli.
...
* Then **systematic noting** or clear observation:
  ...
  * detect [impermanence](../../01_core_teachings/impermanence/README.md#2-impermanence-anicca-is-structural-not-accidental), [unsatisfactoriness](../../02_from_ignorance_to_awakening/2_the_four_noble_truths/README.md#1-there-is-patnja--dukkha), not-self
...
* **Over-labeling**: turning praksa into narration (concepts replace perception)
* **Micro-controlling**: tension, “tight” attention
* **Insight chasing**: destabilization without enough samatha
* **Subtle duality**: a watcher watching objekti forever
...
* misli are seen as **movements within awareness**
...
* not fixating (otvorenost maintained)
...
* misli arise and dissolve without leaving traces
...
| Praksa   |            Selectivity | Effort style           | Primary move                       | “Unit” of progress                  |
| ---------- | ---------------------: | ---------------------- | ---------------------------------- | ----------------------------------- |
...
| Shikantaza |                  broad | minimal, release-based | don’t interfere; return to sitting | less hooking, more wakeful otvorenost |
| [Mahāmudrā](#3-mahāmudrā-kagyusakya-etc---“object-to-awareness-pivot-nondual-shamathainsight”)  |               variable | probe-then-rest        | pivot from objekti → [awareness](#2-shikantaza-zen-“just-sitting”---“global-awareness-with-minimal-intervention”)     | stable nondual clarity              |
...
* **Shikantaza**: stable wakefulness with ordinary simplicity; misli lose authority
* **Mahāmudrā**: effortless clarity where misli are transparent movements
* **Dzogchen**: vivid presence where arising misli self-release immediately
...
< [What is a Yāna?](../README.md) | [1) How they *structure* the put](../zen_and_theravada/README.md) >

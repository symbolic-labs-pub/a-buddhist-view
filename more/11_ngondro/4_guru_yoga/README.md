## [The Fourth Ngöndro Practice](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/master/more/11_ngondro/4_guru_yoga/README.md#the-fourth-ngöndro-practice)

[![guru_yoga](guru_yoga.png)](https://github.com/symbolic-labs-pub/a-buddhist-view/blob/master/more/11_ngondro/4_guru_yoga/README.md#the-fourth-ngöndro-practice)
### **Samsāra’s Unsatisfactoriness → Guru Yoga**

In the Kagyu understanding of **Ngöndro**, the **fourth practice** completes the *outer turning of the mind* and *opens the inner path*. It is the hinge where **renunciation matures into direct recognition**.
...
Until this insight is **emotionally internalized**, practice remains instrumental:

* [meditation](../../08_lineage/README.md) becomes self-improvement,
* [ethics](../../01_core_teachings/the_noble_eightfold_path/README.md#2-ethical-conduct-śīla) becomes reputation management,
* devotion becomes projection.

The fourth contemplation **cuts the last hope** that samsāra can be refined into [awakening](../../10_concepts/README.md#3-enlightenment-bodhi-awakening).
...
* untrained ordinary [awareness](../../10_concepts/README.md#2-awareness-rigpa-vijñāna-knowing)
...
* “Teacher” and “student” are provisional roles
...
* Realization is **patterned awareness**
...
* He is **not a savior**
* He represents **unbroken transmission of [Mahāmudrā](../../04_kayas/mahamudra_and_dzogcsen/README.md#mahāmudrā-nature-of-mind-སེམས་ཀྱི་གནས་ལུགས་) realization**
...
| Practice reinforces self | Practice dissolves self      |

Samsāra’s [unsatisfactoriness](../../02_from_ignorance_to_awakening/2_the_four_noble_truths/README.md#1-there-is-suffering--dukkha) **empties the cup**.

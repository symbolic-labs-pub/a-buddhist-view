...
![lineage_holders.png](lineage_holders.png)
...
flowchart TB
  ...
  %% LEGEND TITLE
  %% =========================
  Title["📘 Karma Kagyu Lineage Graph — Legend"]:::title

  %% =========================
  %% NODE TYPE LEGEND
  %% =========================
  P["🟡 Person / Lineage Holder\n(Karmapa, Shamarpa, Rinpoches)"]:::person
  PA["🟣 Branch A Person\n(Ogyen Trinley Dorje)"]:::personA
  PB["🟤 Branch B Person\n(Trinley Thaye Dorje)"]:::personB

  I["🏯 Institution / Seat\n(Monasteries, Institutes, Places)"]:::inst
  D["📜 Document / Artifact\n(Prediction letters, texts)"]:::doc
  L["⚖ Legal / Court Axis\n(Institutional control, rulings)"]:::legal
  J["🤝 Joint / Reconciliation\n(Shared statements, convergence)"]:::joint

  %% =========================
  %% EDGE TYPE LEGEND
  %% =========================
  E1["→ INSTITUTION / FOUNDING"]:::edgeInst
  E2["→ DISCIPLESHIP / TRANSMISSION"]:::edgePerson
  E3["→ RECOGNITION / ENTHRONEMENT"]:::edgeRecognize
  E4["⇢ DISPUTE / CONTESTATION"]:::edgeDispute
  E5["→ LEGAL ACTION"]:::edgeLegal
  E6["→ JOINT STATEMENT"]:::edgeJoint

  %% =========================
  %% LAYOUT LINKS (visual only)
  %% =========================
  Title --> P
  Title --> I
  P --> PA
...
**[Guru Rinpoche (Padmasambhava)](https://en.wikipedia.org/wiki/Padmasambhava)** is foundational mainly to the **[Nyingma](https://www.rigpawiki.org/index.php?title=Nyingma)** (“Ancient”) school and its two transmission streams: **Kama (oral)** and **Terma (treasure)**. ([Wikipedia][1])
...
* **1981** — Passes away (parinirvāṇa). ([Rigpa Wiki][5])
...
After the 16th Karmapa’s passing, a council/regency was formed by his four principal disciples (“heart sons”), commonly listed as:
...
flowchart LR
  %% ==========================================
  %% 🌈 Karma Kagyu lineage graph
  %% - Color groups via classDef + subgraphs
  %% - Lines colored by meaning via linkStyle (order-sensitive)
  %% ==========================================

  %% ---------- People ----------
  K16["👑 H.H. 16th Karmapa<br/>Rangjung Rigpe Dorje<br/>(1924–1981)"]
  K17A["👑 17th Karmapa (Branch A)<br/>Ogyen Trinley Dorje<br/>(b. 1985)"]
  K17B["👑 17th Karmapa (Branch B)<br/>Trinley Thaye Dorje<br/>(b. 1983)"]

  SH14["🟥 14th Shamarpa<br/>Mipham Chökyi Lodrö<br/>(1952–2014)"]
  TS12["🟦 12th Tai Situ Rinpoche"]
  GY12["🟩 12th Goshir Gyaltsab Rinpoche"]
  JKX["🟪 Jamgön Kongtrül Rinpoche<br/>(regency era)"]

  DL14["☸️ H.H. 14th Dalai Lama"]

  %% ---------- Institutions / Seats ----------
  Rumtek["🏯 Rumtek Monastery<br/>(Sikkim, India)<br/>Exile seat"]
  Tsurphu["🏯 Tsurphu Monastery<br/>(Tibet)<br/>Traditional seat"]
  KIBI["🎓 KIBI<br/>New Delhi, India"]
  Dharamsala["🏔️ Dharamsala<br/>HP, India"]
  BodhGaya["🕯️ Bodh Gaya<br/>Bihar, India"]

  KagyuOffice["🌐 Kagyu Office<br/>(kagyuoffice.org)<br/>Branch A comms"]
  KarmapaOrg["🌐 karmapa.org<br/>Branch B comms"]

  %% ---------- Documents / Events ----------
  PredLetter["📜 Contested “Prediction Letter”<br/>(recognition process)"]
  Joint2018["🤝 Joint Statement<br/>2018-10-11<br/>(France meeting)"]
  Joint2023["🤝 Joint Statement<br/>2023-12-04<br/>(Shamarpa reincarnation cooperation)"]

  RumtekCase["⚖️ Rumtek legal rulings<br/>2003-08-26 (Sikkim HC)<br/>2004-07-05 (India SC)"]

  %% ==========================================
  %% GROUPING (subgraphs)
  %% ==========================================
  subgraph A["🧡 Core Lineage Anchor"]
    K16
  end

  subgraph B["💛 Recognition & Enthronement Branches (Post-1981)"]
    K17A
    K17B
    PredLetter
  end

  subgraph C["💙 Regency / Senior Disciples (Heart-Sons era)"]
    SH14
    TS12
    GY12
    JKX
  ...
  subgraph E["🩶 Governance / Legal / Admin"]
    RumtekCase
    KagyuOffice
    KarmapaOrg
  end

  subgraph F["💜 Reconciliation / Unity Track"]
    Joint2018
    Joint2023
  end

  %% ==========================================
  %% EDGES (keep order; linkStyle indexes refer to these)
  %% ==========================================

  %% (1) Institutional building
  K16 -->|🏗️ ESTABLISHES SEAT • 1966| Rumtek
  K16 -->|🏗️ FOUNDS • 1979-11| KIBI

  %% (2) Discipleship / transmission
  K16 -->|🧘 TRANSMISSION • pre-1981| SH14
  K16 -->|🧘 TRANSMISSION • pre-1981| TS12
  K16 -->|🧘 TRANSMISSION • pre-1981| GY12
  K16 -->|🧘 TRANSMISSION • pre-1981| JKX

  %% (3) Regency roles
  SH14 -->|🧭 REGENCY • 1981→1990s| Rumtek
  TS12 -->|🧭 REGENCY • 1981→1990s| Rumtek
  GY12 -->|🧭 REGENCY • 1981→1990s| Rumtek
  JKX -->|🧭 REGENCY • 1981→1990s| Rumtek

  %% (4) Recognition split mechanics
  TS12 -->|📜 PRESENTS • early 1990s| PredLetter
  SH14 -->|❗ CONTESTS • 1990s| PredLetter
  PredLetter -->|🧩 INFLUENCES • 1992| K17A

  DL14 -->|✅ RECOGNITION • 1992-06-30| K17A
  K17A -->|👑 ENTHRONED • 1992-09-27| Tsurphu
  K17A -->|🧳 ARRIVAL • 2000-01-05| Dharamsala

  SH14 -->|✅ RECOGNITION • 1994-03| K17B
  K17B -->|👑 ENTHRONED • 1996-12| BodhGaya

  %% (5) Admin / comms
  K17A -->|📣 COMMS • 2000s→| KagyuOffice
  K17B -->|📣 COMMS • 1990s→| KarmapaOrg

  %% (6) Legal axis
  Rumtek -->|⚖️ LEGAL • 2003–2004| RumtekCase
  RumtekCase -->|🏛️ AFFECTS ADMIN • 2000s→| Rumtek

  %% (7) Reconciliation
  K17A -->|🤝 JOINT • 2018-10-11| Joint2018
  K17B -->|🤝 JOINT • 2018-10-11| Joint2018
  K17A -->|🤝 JOINT • 2023-12-04| Joint2023
  K17B -->|🤝 JOINT • 2023-12-04| Joint2023
  Joint2023 -->|🧬 LINEAGE PROCESS • future| SH14
  ...
  %% ==========================================
  %% STYLES (edges by meaning) — order-sensitive
  %% 0-1: build/institution (orange)
  %% 2-5: transmission (green)
  %% 6-9: regency (teal)
  %% 10-12: recognition mechanics (gray)
  %% 13-15: Branch A recognition/enthrone/relocation (blue)
  %% 16-17: Branch B recognition/enthrone (pink)
  %% 18-19: comms/admin (cyan)
  %% 20-21: legal axis (red)
  %% 22-26: reconciliation (purple)
  %% ==========================================
```
